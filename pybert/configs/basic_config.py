...
BASE_DIR = Path('C:/Users/mailp/Bert-Multi-Label-Text-Classification/pybert')
config = {
    ...
    'bert_vocab_path':  BASE_DIR / 'pretrain/bert/base-uncased/bert_vocab',
    'bert_config_file': 'C:/Users/mailp/Bert-Multi-Label-Text-Classification/pybert/pretrain/bert/base-uncased/config.json',
